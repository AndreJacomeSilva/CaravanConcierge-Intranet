...
/** *** */ (function (modules) { // webpackBootstrap
    ...
    /* 2 */
    /***/ function (module, exports, __webpack_require__) {
      const getTimezoneOffsetInMilliseconds = __webpack_require__(3);
      const isDate = __webpack_require__(4);
      ...
      function parse(argument, dirtyOptions) {
	    ...
	    const { year } = parseYearResult;
	    const { restDateString } = parseYearResult;
    ...
    /* 5 */
    /***/ function (module, exports, __webpack_require__) {
      const addMilliseconds = __webpack_require__(6);
      const MILLISECONDS_IN_HOUR = 3600000;
    ...
    /* 7 */
    /***/ function (module, exports, __webpack_require__) {
      const getISOYear = __webpack_require__(8);
      const setISOYear = __webpack_require__(11);
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const startOfISOWeek = __webpack_require__(9);
    ...
    /* 9 */
    /***/ function (module, exports, __webpack_require__) {
      const startOfWeek = __webpack_require__(10);
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const startOfISOYear = __webpack_require__(12);
      const differenceInCalendarDays = __webpack_require__(13);
    ...
    /* 13 */
    /***/ function (module, exports, __webpack_require__) {
      const startOfDay = __webpack_require__(14);
      const MILLISECONDS_IN_MINUTE = 60000;
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const getDaysInMonth = __webpack_require__(17);
    ...
    /* 18 */
    /***/ function (module, exports, __webpack_require__) {
      const addMonths = __webpack_require__(16);
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function closestIndexTo(dirtyDateToCompare, dirtyDatesArray) {
	    ...
	    let result;
	    let minDistance;
	    dirtyDatesArray.forEach((dirtyDate, index) => {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function closestTo(dirtyDateToCompare, dirtyDatesArray) {
	    ...
	    let result;
	    let minDistance;
	    dirtyDatesArray.forEach((dirtyDate) => {
	        const currentDate = parse(dirtyDate);
	        const distance = Math.abs(timeToCompare - currentDate.getTime());
	        if (result === undefined || distance < minDistance) {
	            result = currentDate;
    ...
    /* 30 */
    /***/ function (module, exports, __webpack_require__) {
      const getQuarter = __webpack_require__(31);
      const parse = __webpack_require__(2);
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const differenceInCalendarDays = __webpack_require__(13);
      const compareAsc = __webpack_require__(25);
    ...
    /* 35 */
    /***/ function (module, exports, __webpack_require__) {
      const differenceInMilliseconds = __webpack_require__(36);
      const MILLISECONDS_IN_HOUR = 3600000;
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const differenceInCalendarISOYears = __webpack_require__(28);
      const compareAsc = __webpack_require__(25);
      const subISOYears = __webpack_require__(38);
    ...
    /* 38 */
    /***/ function (module, exports, __webpack_require__) {
      const addISOYears = __webpack_require__(7);
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const differenceInCalendarMonths = __webpack_require__(29);
      const compareAsc = __webpack_require__(25);
    ...
    /* 41 */
    /***/ function (module, exports, __webpack_require__) {
      const differenceInMonths = __webpack_require__(40);
    ...
    /* 43 */
    /***/ function (module, exports, __webpack_require__) {
      const differenceInDays = __webpack_require__(34);
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const differenceInCalendarYears = __webpack_require__(33);
      const compareAsc = __webpack_require__(25);
    ...
    /* 45 */
    /***/ function (module, exports, __webpack_require__) {
      const compareDesc = __webpack_require__(26);
      const parse = __webpack_require__(2);
      const differenceInSeconds = __webpack_require__(42);
      const differenceInMonths = __webpack_require__(40);
      const enLocale = __webpack_require__(46);
      ...
      function distanceInWords(dirtyDateToCompare, dirtyDate, dirtyOptions) {
	    ...
	    let comparison = compareDesc(dirtyDateToCompare, dirtyDate);
	    let {locale} = options;
	    let {localize} = enLocale.distanceInWords;
...
dateRight;
	    ...
	    let seconds = differenceInSeconds(dateRight, dateLeft);
	    let offset = dateRight.getTimezoneOffset() - dateLeft.getTimezoneOffset();
	    let minutes = Math.round(seconds / 60) - offset;
	    let months;
	    if (minutes < 2) {
	        ...
	        let days = Math.round(minutes / MINUTES_IN_DAY);
	    ...
	    if (months < 12) {
	        let nearestMonth = Math.round(minutes / MINUTES_IN_MONTH);
	        return localize('xMonths', nearestMonth, localizeOptions);
	    } else {
	        let monthsSinceStartOfYear = months % 12;
    ...
    /* 46 */
    /***/ function (module, exports, __webpack_require__) {
      const buildDistanceInWordsLocale = __webpack_require__(47);
      const buildFormatLocale = __webpack_require__(48);
      module.exports = {
    ...
    /* 48 */
    /***/ function (module, exports, __webpack_require__) {
      const buildFormattingTokensRegExp = __webpack_require__(49);
...
dateRight;
	    ...
	    let unit;
	    let mathPartial = Math[options.partialMethod ? String(options.partialMethod) : 'floor'];
	    let seconds = differenceInSeconds(dateRight, dateLeft);
	    let offset = dateRight.getTimezoneOffset() - dateLeft.getTimezoneOffset();
	    let minutes = mathPartial(seconds / 60) - offset;
	    let hours; var days; var months; var 
years;
	    if (options.unit) {
    ...
    /* 51 */
    /***/ function (module, exports, __webpack_require__) {
      const distanceInWords = __webpack_require__(45);
    ...
    /* 55 */
    /***/ function (module, exports, __webpack_require__) {
      const endOfWeek = __webpack_require__(56);
    ...
    /* 62 */
    /***/ function (module, exports, __webpack_require__) {
      const endOfDay = __webpack_require__(53);
      function endOfToday() {
    ...
    /* 66 */
    /***/ function (module, exports, __webpack_require__) {
      const getDayOfYear = __webpack_require__(67);
      const getISOWeek = __webpack_require__(69);
      const getISOYear = __webpack_require__(8);
      const parse = __webpack_require__(2);
      const isValid = __webpack_require__(70);
      const enLocale = __webpack_require__(46);
      function format(dirtyDate, dirtyFormatStr, dirtyOptions) {
	    ...
	    let { formattingTokensRegExp } = enLocale.format;
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const startOfYear = __webpack_require__(68);
      const differenceInCalendarDays = __webpack_require__(13);
    ...
    /* 73 */
    /***/ function (module, exports, __webpack_require__) {
      const isLeapYear = __webpack_require__(74);
    ...
    /***/ function (module, exports, __webpack_require__) {
      const startOfISOYear = __webpack_require__(12);
      const addWeeks = __webpack_require__(20);
      const MILLISECONDS_IN_WEEK = 604800000;
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const endOfDay = __webpack_require__(53);
      const endOfMonth = __webpack_require__(59);
    ...
    /* 95 */
    /***/ function (module, exports, __webpack_require__) {
      const startOfHour = __webpack_require__(96);
    ...
    /* 97 */
    /***/ function (module, exports, __webpack_require__) {
      const isSameWeek = __webpack_require__(98);
    ...
    /* 100 */
    /***/ function (module, exports, __webpack_require__) {
      const startOfMinute = __webpack_require__(101);
    ...
    /* 103 */
    /***/ function (module, exports, __webpack_require__) {
      const startOfQuarter = __webpack_require__(104);
    ...
    /* 105 */
    /***/ function (module, exports, __webpack_require__) {
      const startOfSecond = __webpack_require__(106);
    ...
    /* 110 */
    /***/ function (module, exports, __webpack_require__) {
      const isSameHour = __webpack_require__(95);
    ...
    /* 111 */
    /***/ function (module, exports, __webpack_require__) {
      const isSameISOWeek = __webpack_require__(97);
    ...
    /* 112 */
    /***/ function (module, exports, __webpack_require__) {
      const isSameISOYear = __webpack_require__(99);
    ...
    /* 113 */
    /***/ function (module, exports, __webpack_require__) {
      const isSameMinute = __webpack_require__(100);
    ...
    /* 114 */
    /***/ function (module, exports, __webpack_require__) {
      const isSameMonth = __webpack_require__(102);
    ...
    /* 115 */
    /***/ function (module, exports, __webpack_require__) {
      const isSameQuarter = __webpack_require__(103);
    ...
    /* 116 */
    /***/ function (module, exports, __webpack_require__) {
      const isSameSecond = __webpack_require__(105);
    ...
    /* 118 */
    /***/ function (module, exports, __webpack_require__) {
      const isSameYear = __webpack_require__(107);
    ...
    /* 127 */
    /***/ function (module, exports, __webpack_require__) {
      const lastDayOfWeek = __webpack_require__(128);
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function max() {
	    ...
	    const dates = dirtyDates.map((dirtyDate) => parse(dirtyDate));
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const addDays = __webpack_require__(1);
      const getISODay = __webpack_require__(76);
    ...
    /***/ function (module, exports, __webpack_require__) {
      const parse = __webpack_require__(2);
      const setMonth = __webpack_require__(143);
    ...
    /* 152 */
    /***/ function (module, exports, __webpack_require__) {
      const addHours = __webpack_require__(5);
    ...
    /* 154 */
    /***/ function (module, exports, __webpack_require__) {
      const addMinutes = __webpack_require__(15);
    ...
    /* 156 */
    /***/ function (module, exports, __webpack_require__) {
      const addQuarters = __webpack_require__(18);
    ...
    /* 157 */
    /***/ function (module, exports, __webpack_require__) {
      const addSeconds = __webpack_require__(19);
    ...
    /* 159 */
    /***/ function (module, exports, __webpack_require__) {
      const addYears = __webpack_require__(21);
